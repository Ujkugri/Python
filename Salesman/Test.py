...
# city21 = City(80, 100)
# city_list.append(city21)
# city22 = City(67, 85)
# city_list.append(city22)
# city23 = City(120, 81)
# city_list.append(city23)
# city24 = City(18, 6)
# city_list.append(city24)
# city25 = City(130, 40)
# city_list.append(city25)
# city26 = City(8, 8)
# city_list.append(city26)
# city27 = City(200, 120)
# city_list.append(city27)
# city28 = City(120, 120)
# city_list.append(city28)
# city29 = City(160, 70)
# city_list.append(city29)
# city30 = City(110, 33)
# city_list.append(city30)


for i in range(0, city_count):
    city_list.append(City(x=int(random.random() * 400), y=int(random.random() * 400)))
...
geneticAlgorithmPlot(population=city_list, popSize=100, eliteSize=30, mutationRate=0.001, generations=city_count**2)
