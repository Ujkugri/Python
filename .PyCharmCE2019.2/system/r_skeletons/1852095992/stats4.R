...
.__C__mle <- new("classRepresentation", slots = list(call = structure("language", package = "methods"), 
    ...
    nobs = structure("integer", package = "methods"), method = structure("character", package = "methods")), 
    contains = list(), virtual = FALSE, prototype = S4_object(), 
    validity = NULL, access = list(), className = structure("mle", package = "stats4"), 
    package = "stats4", subclasses = list(), versionKey = <pointer: (nil)>, 
    sealed = FALSE)
...
.__C__profile.mle <- new("classRepresentation", slots = list(profile = structure("list", package = "methods"), 
    summary = structure("summary.mle", package = "stats4")), 
    contains = list(), virtual = FALSE, prototype = S4_object(), 
    validity = NULL, access = list(), className = structure("profile.mle", package = "stats4"), 
    package = "stats4", subclasses = list(), versionKey = <pointer: (nil)>, 
    sealed = FALSE)
...
.__C__summary.mle <- new("classRepresentation", slots = list(call = structure("language", package = "methods"), 
    coef = structure("matrix", package = "methods"), m2logL = structure("numeric", package = "methods")), 
    contains = list(), virtual = FALSE, prototype = S4_object(), 
    validity = NULL, access = list(), className = structure("summary.mle", package = "stats4"), 
    package = "stats4", subclasses = list(), versionKey = <pointer: (nil)>, 
    sealed = FALSE)
