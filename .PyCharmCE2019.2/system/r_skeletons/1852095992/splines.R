...
interpSpline <- function (obj1, obj2, bSpline = FALSE, period = NULL, ord = 4L, 
    na.action = na.fail, sparse = FALSE) 
UseMethod("interpSpline")


splineDesign <- function (knots, x, ord = 4L, derivs = 0L, outer.ok = FALSE, 
    sparse = FALSE) 
{
...
periodicSpline <- function (obj1, obj2, knots, period = 2 * pi, ord = 4L) 
