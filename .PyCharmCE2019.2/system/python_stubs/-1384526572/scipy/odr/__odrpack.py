...
# from C:\Program Files (x86)\Python37-32\lib\site-packages\scipy\odr\__odrpack.cp37-win32.pyd
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0997A9F0>'

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.odr.__odrpack', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0997A9F0>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\scipy\\\\odr\\\\__odrpack.cp37-win32.pyd')"
