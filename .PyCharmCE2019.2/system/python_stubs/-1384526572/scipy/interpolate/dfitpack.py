...
def spalde(t, c, k, x): # real signature unknown; restored from __doc__
    """
    d,ier = spalde(t,c,k,x)
...
def surfit_lsq(x, y, z, tx, ty, w=None, xb=None, xe=None, yb=None, ye=None, kx=None, ky=None, eps=None, lwrk2=None, overwrite_tx=None, overwrite_ty=None): # real signature unknown; restored from __doc__
    """
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0F86DDB0>'

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.interpolate.dfitpack', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0F86DDB0>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\scipy\\\\interpolate\\\\dfitpack.cp37-win32.pyd')"
