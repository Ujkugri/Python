...
class Heap(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0F206548>'
...
class LinkageUnionFind(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0F2065A8>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0F227B30>'

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.cluster._hierarchy', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0F227B30>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\scipy\\\\cluster\\\\_hierarchy.cp37-win32.pyd')"
