# encoding: utf-8
# module numpy.core._rational_tests
...
class rational(__numpy.generic):
    ...
    dtype = dtype(rational)


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0336E0B0>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.core._rational_tests', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0336E0B0>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\numpy\\\\core\\\\_rational_tests.cp37-win32.pyd')"
