...
def _csr_polynomial_expansion(*args, **kwargs): # real signature unknown
    """
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x1093CF70>'

__spec__ = None # (!) real value is "ModuleSpec(name='sklearn.preprocessing._csr_polynomial_expansion', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x1093CF70>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\sklearn\\\\preprocessing\\\\_csr_polynomial_expansion.cp37-win32.pyd')"
