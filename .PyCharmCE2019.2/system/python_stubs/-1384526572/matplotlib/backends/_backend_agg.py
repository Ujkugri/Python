...
# from C:\Program Files (x86)\Python37-32\lib\site-packages\matplotlib\backends\_backend_agg.cp37-win32.pyd
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x097A44D0>'

__spec__ = None # (!) real value is "ModuleSpec(name='matplotlib.backends._backend_agg', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x097A44D0>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\matplotlib\\\\backends\\\\_backend_agg.cp37-win32.pyd')"
