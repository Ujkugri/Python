...
# from C:\Program Files (x86)\Python37-32\lib\site-packages\matplotlib\_path.cp37-win32.pyd
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x02FB01B0>'

__spec__ = None # (!) real value is "ModuleSpec(name='matplotlib._path', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x02FB01B0>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\matplotlib\\\\_path.cp37-win32.pyd')"
