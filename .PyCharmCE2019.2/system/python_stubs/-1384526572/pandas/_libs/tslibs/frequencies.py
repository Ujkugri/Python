...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0963B410>'

__pyx_capi__ = {
    'get_base_alias': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x09555E30>'
    'get_freq': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x09555DE8>'
    'get_freq_code': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x09555DB8>'
    'get_freq_str': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6pandas_5_libs_6tslibs_11frequencies_get_freq_str *__pyx_optional_args)" at 0x09555C20>'
    'get_rule_month': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6pandas_5_libs_6tslibs_11frequencies_get_rule_month *__pyx_optional_args)" at 0x09555E18>'
    'get_to_timestamp_base': None, # (!) real value is '<capsule object "int (int, int __pyx_skip_dispatch)" at 0x09555E60>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.frequencies', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0963B410>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\frequencies.cp37-win32.pyd')"

__test__ = {
    'get_freq (line 306)': "\n    Return frequency code of given frequency str.\n    If input is not string, return input as it is.\n\n    Examples\n    --------\n    >>> get_freq('A')\n    1000\n\n    >>> get_freq('3A')\n    1000\n    ",
    'get_freq_code (line 130)': "\n    Return freq str or tuple to freq code and stride (mult)\n\n    Parameters\n    ----------\n    freqstr : str or tuple\n\n    Returns\n    -------\n    return : tuple of base frequency code and stride (mult)\n\n    Examples\n    --------\n    >>> get_freq_code('3D')\n    (6000, 3)\n\n    >>> get_freq_code('D')\n    (6000, 1)\n\n    >>> get_freq_code(('D', 3))\n    (6000, 3)\n    ",
    'get_freq_str (line 226)': '\n    Return the summary string associated with this offset code, possibly\n    adjusted by a multiplier.\n\n    Parameters\n    ----------\n    base : int (member of FreqGroup)\n\n    Returns\n    -------\n    freq_str : str\n\n    Examples\n    --------\n    >>> get_freq_str(1000)\n    \'A-DEC\'\n\n    >>> get_freq_str(2000, 2)\n    \'2Q-DEC\'\n\n    >>> get_freq_str("foo")\n    ',
    'get_rule_month (line 485)': '\n    Return starting month of given freq, default is December.\n\n    Parameters\n    ----------\n    source : object\n    default : object (default "DEC")\n\n    Returns\n    -------\n    rule_month: object (usually string)\n\n    Examples\n    --------\n    >>> get_rule_month(\'D\')\n    \'DEC\'\n\n    >>> get_rule_month(\'A-JAN\')\n    \'JAN\'\n    ',
    'get_to_timestamp_base (line 270)': "\n    Return frequency code group used for base of to_timestamp against\n    frequency code.\n\n    Parameters\n    ----------\n    base : int (member of FreqGroup)\n\n    Returns\n    -------\n    base : int\n\n    Examples\n    --------\n    # Return day freq code against longer freq than day\n    >>> get_to_timestamp_base(get_freq_code('D')[0])\n    6000\n    >>> get_to_timestamp_base(get_freq_code('W')[0])\n    6000\n    >>> get_to_timestamp_base(get_freq_code('M')[0])\n    6000\n\n    # Return second freq code against hour between second\n    >>> get_to_timestamp_base(get_freq_code('H')[0])\n    9000\n    >>> get_to_timestamp_base(get_freq_code('S')[0])\n    9000\n    ",
}
