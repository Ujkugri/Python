...
# from C:\Program Files (x86)\Python37-32\lib\site-packages\PIL\_imagingcms.cp37-win32.pyd
# by generator 1.147
# no doc
# no imports
...
def get_display_profile_win32(*args, **kwargs): # real signature unknown
    pass
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x034FE0D0>'

__spec__ = None # (!) real value is "ModuleSpec(name='PIL._imagingcms', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x034FE0D0>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\PIL\\\\_imagingcms.cp37-win32.pyd')"
