...
class ExtType(__pandas_io_msgpack.ExtType):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas.io.msgpack', '__doc__': 'ExtType represents ext type in msgpack.', '__new__': <staticmethod object at 0x0A00AA90>, '__dict__': <attribute '__dict__' of 'ExtType' objects>})"
...
class Packer(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x09FF9830>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0A00AB90>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas.io.msgpack._packer', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0A00AB90>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\pandas\\\\io\\\\msgpack\\\\_packer.cp37-win32.pyd')"
