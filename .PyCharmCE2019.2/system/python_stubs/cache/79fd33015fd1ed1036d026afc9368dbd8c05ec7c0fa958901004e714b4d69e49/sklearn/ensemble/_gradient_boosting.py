...
def np_zeros(*args, **kwargs): # real signature unknown
    """
...
def _predict_regression_tree_stages_sparse(*args, **kwargs): # real signature unknown
    """
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x10D1C3B0>'

__spec__ = None # (!) real value is "ModuleSpec(name='sklearn.ensemble._gradient_boosting', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x10D1C3B0>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\sklearn\\\\ensemble\\\\_gradient_boosting.cp37-win32.pyd')"
