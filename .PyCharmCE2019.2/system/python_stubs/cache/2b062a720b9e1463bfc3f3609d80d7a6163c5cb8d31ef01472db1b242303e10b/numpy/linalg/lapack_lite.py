...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0358C8D0>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.linalg.lapack_lite', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0358C8D0>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\numpy\\\\linalg\\\\lapack_lite.cp37-win32.pyd')"
