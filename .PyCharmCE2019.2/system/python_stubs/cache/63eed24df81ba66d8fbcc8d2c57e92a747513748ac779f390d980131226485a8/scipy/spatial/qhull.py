...
# from C:\Program Files (x86)\Python37-32\lib\site-packages\scipy\spatial\qhull.cp37-win32.pyd
# by generator 1.147
"""
...
import threading as threading # C:\Program Files (x86)\Python37-32\lib\threading.py
import numpy as np # C:\Program Files (x86)\Python37-32\lib\site-packages\numpy\__init__.py
import os as os # C:\Program Files (x86)\Python37-32\lib\os.py
import sys as sys # <module 'sys' (built-in)>
import tempfile as tempfile # C:\Program Files (x86)\Python37-32\lib\tempfile.py
...
class _QhullUser(object):
    ...
    _qhull = None
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'scipy.spatial.qhull', '__doc__': '\\n    Takes care of basic dealings with the Qhull objects\\n    ', '_qhull': None, '__init__': <cyfunction _QhullUser.__init__ at 0x09EC5100>, 'close': <cyfunction _QhullUser.close at 0x09EC5168>, '__del__': <cyfunction _QhullUser.__del__ at 0x09EC51D0>, '_update': <cyfunction _QhullUser._update at 0x09EC5238>, '_add_points': <cyfunction _QhullUser._add_points at 0x09EC52A0>, '__dict__': <attribute '__dict__' of '_QhullUser' objects>, '__weakref__': <attribute '__weakref__' of '_QhullUser' objects>})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x09ECE810>'

__pyx_capi__ = {
    '_barycentric_coordinate_single': None, # (!) real value is '<capsule object "void (int, double *, double *, double *, int)" at 0x09EA9E48>'
    '_barycentric_coordinates': None, # (!) real value is '<capsule object "void (int, double *, double *, double *)" at 0x09EA9E60>'
    '_barycentric_inside': None, # (!) real value is '<capsule object "int (int, double *, double *, double *, double)" at 0x09EA9E30>'
    '_distplane': None, # (!) real value is '<capsule object "double (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, int, double *)" at 0x09EA9E90>'
    '_find_simplex': None, # (!) real value is '<capsule object "int (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, double *, double *, int *, double, double)" at 0x09EA9EF0>'
    '_find_simplex_bruteforce': None, # (!) real value is '<capsule object "int (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, double *, double *, double, double)" at 0x09EA9EC0>'
    '_find_simplex_directed': None, # (!) real value is '<capsule object "int (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, double *, double *, int *, double, double)" at 0x09EA9ED8>'
    '_get_delaunay_info': None, # (!) real value is '<capsule object "int (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, PyObject *, int, int, int)" at 0x09EA9E18>'
    '_is_point_fully_outside': None, # (!) real value is '<capsule object "int (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, double *, double)" at 0x09EA9EA8>'
    '_lift_point': None, # (!) real value is '<capsule object "void (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, double *, double *)" at 0x09EA9E78>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.spatial.qhull', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x09ECE810>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\scipy\\\\spatial\\\\qhull.cp37-win32.pyd')"
