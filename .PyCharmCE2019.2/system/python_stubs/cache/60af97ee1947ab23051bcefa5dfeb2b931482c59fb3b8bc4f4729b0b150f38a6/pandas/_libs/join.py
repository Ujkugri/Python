...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x09C7F250>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.join', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x09C7F250>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\join.cp37-win32.pyd')"
