...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x09F2CAD0>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.reshape', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x09F2CAD0>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\reshape.cp37-win32.pyd')"
