...
class BlockIndex(SparseIndex):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0A6DAE00>'
...
class BlockMerge(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0A6DAE18>'
...
class BlockUnion(BlockMerge):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0A6DAE48>'
...
class IntIndex(SparseIndex):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0A6DADA0>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0A6FF210>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.sparse', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0A6FF210>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\sparse.cp37-win32.pyd')"
