...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x095AB7B0>'

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.ndimage._nd_image', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x095AB7B0>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\scipy\\\\ndimage\\\\_nd_image.cp37-win32.pyd')"
