...
def solve(a, b, sym_pos=False, lower=False, overwrite_a=False, overwrite_b=False, debug=None, check_finite=True, assume_a=None, transposed=False): # reliably restored by inspect
    """
...
def solve_triangular(a, b, trans=0, lower=False, unit_diagonal=False, overwrite_b=False, debug=None, check_finite=True): # reliably restored by inspect
    """
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x104A8970>'

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.optimize._bglu_dense', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x104A8970>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\scipy\\\\optimize\\\\_bglu_dense.cp37-win32.pyd')"
