...
# from C:\Program Files (x86)\Python37-32\lib\site-packages\pandas\_libs\tslibs\timezones.cp37-win32.pyd
# by generator 1.147
# no doc
...
class _dateutil_tzutc(__datetime.tzinfo):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'dateutil.tz.tz\', \'__doc__\': "\\n    This is a tzinfo object that represents the UTC time zone.\\n\\n    **Examples:**\\n\\n    .. doctest::\\n\\n        >>> from datetime import *\\n        >>> from dateutil.tz import *\\n\\n        >>> datetime.now()\\n        datetime.datetime(2003, 9, 27, 9, 40, 1, 521290)\\n\\n        >>> datetime.now(tzutc())\\n        datetime.datetime(2003, 9, 27, 12, 40, 12, 156379, tzinfo=tzutc())\\n\\n        >>> datetime.now(tzutc()).tzname()\\n        \'UTC\'\\n\\n    .. versionchanged:: 2.7.0\\n        ``tzutc()`` is now a singleton, so the result of ``tzutc()`` will\\n        always return the same object.\\n\\n        .. doctest::\\n\\n            >>> from dateutil.tz import tzutc, UTC\\n            >>> tzutc() is tzutc()\\n            True\\n            >>> tzutc() is UTC\\n            True\\n    ", \'utcoffset\': <function tzutc.utcoffset at 0x0A50D8A0>, \'dst\': <function tzutc.dst at 0x0A4263D8>, \'tzname\': <function tzutc.tzname at 0x0A426420>, \'is_ambiguous\': <function tzutc.is_ambiguous at 0x0A426468>, \'fromutc\': <function tzutc.fromutc at 0x0A4264F8>, \'__eq__\': <function tzutc.__eq__ at 0x0A426540>, \'__hash__\': None, \'__ne__\': <function tzutc.__ne__ at 0x0A426588>, \'__repr__\': <function tzutc.__repr__ at 0x0A4265D0>, \'__reduce__\': <method \'__reduce__\' of \'object\' objects>, \'__dict__\': <attribute \'__dict__\' of \'tzutc\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'tzutc\' objects>, \'_TzSingleton__instance\': tzutc()})'
    __hash__ = None
...
class _pytz_BaseTzInfo(__datetime.tzinfo):
    ...
    _tzname = None
    _utcoffset = None
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pytz.tzinfo', '_utcoffset': None, '_tzname': None, 'zone': None, '__str__': <function BaseTzInfo.__str__ at 0x0A29C9C0>, '__dict__': <attribute '__dict__' of 'BaseTzInfo' objects>, '__weakref__': <attribute '__weakref__' of 'BaseTzInfo' objects>, '__doc__': None})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0A52D710>'

__pyx_capi__ = {
    'get_dst_info': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x0A456740>'
    'get_timezone': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0A456530>'
    'get_utcoffset': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *)" at 0x0A456560>'
    'is_fixed_offset': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x0A456818>'
    'is_tzlocal': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x0A456848>'
    'is_utc': None, # (!) real value is '<capsule object "int (PyObject *, int __pyx_skip_dispatch)" at 0x0A4567B8>'
    'maybe_get_tz': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0A456800>'
    'treat_tz_as_dateutil': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x0A456860>'
    'treat_tz_as_pytz': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x0A456878>'
    'tz_compare': None, # (!) real value is '<capsule object "int (PyObject *, PyObject *, int __pyx_skip_dispatch)" at 0x0A456938>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.timezones', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0A52D710>, origin='C:\\\\Program Files (x86)\\\\Python37-32\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\timezones.cp37-win32.pyd')"

__test__ = {
    'tz_standardize (line 324)': '\n    If the passed tz is a pytz timezone object, "normalize" it to the a\n    consistent version\n\n    Parameters\n    ----------\n    tz : tz object\n\n    Returns:\n    -------\n    tz object\n\n    Examples:\n    --------\n    >>> tz\n    <DstTzInfo \'US/Pacific\' PST-1 day, 16:00:00 STD>\n\n    >>> tz_standardize(tz)\n    <DstTzInfo \'US/Pacific\' LMT-1 day, 16:07:00 STD>\n\n    >>> tz\n    <DstTzInfo \'US/Pacific\' LMT-1 day, 16:07:00 STD>\n\n    >>> tz_standardize(tz)\n    <DstTzInfo \'US/Pacific\' LMT-1 day, 16:07:00 STD>\n\n    >>> tz\n    dateutil.tz.tz.tzutc\n\n    >>> tz_standardize(tz)\n    dateutil.tz.tz.tzutc\n    ',
}
